...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await register(formData.username, formData.name, formData.lastName, formData.email, formData.password);
            navigate('/dashboard');
        } catch (error) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#000000]">
            <div className="max-w-md w-full p-8 bg-white rounded-lg border border-gray-200 shadow-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <p href="/login" className="text-sm ">¿Tienes una cuenta? <a className=" text-blue-600 hover:underline" href="/login">Inicia sesión</a> </p>
